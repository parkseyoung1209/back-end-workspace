...
public class A_Variable {
	...
	public void printValue() {
		...
		System.out.println(r * r * pi); // syso 입력 후 ctrl + 스페이스바 -> enter!
	...
	public void variableTest() {
		...
		// 2. 문자형 : 2byte(=16bit)
		char ch = 'a';
//		ch = 'ab'; 에러 발생! --> 주석 단축키 ctrl + /
		
		// 3. 정수형
		byte bNum = 1; // 1byte(8bit)(-128 ~ 127) 256 =2^8
//		bNum = 128; 에러 발생 -> 자료형에서 사용 가능한 범위의 수보다 더 넓은 범위의 수를 사용 -> 오버플로우(Overflow)
		short sNum = 128; // 2byte(=16bit)
		int iNum = 922337283; // 4byte(default)
		long lNum = 922337283458l; // 8byte - 숫자 뒤에 L(l)을 입력
		
		System.out.println(lNum);
		
		// 4. 실수형
		float fNum = 1.2f; // 4byte 이 역시 기본값이 double로 잡혀있어서 숫자 뒤에 f를 넣어야 사용 가능하다
		...
		String name = "장영태"; // 자바에서는 따옴표와 쌍따옴표의 구분을 잘해줘야한다 
							  // => 여러 개의 문자를 넣으려면 반드시 쌍따옴표를 사용해야한다
...
//		int int;
//		... etc
		int class2; // 추가적인 문자열이나 숫자를 붙이면 해당사항이 아니다.
		
		// 5. (권장사항) 낙타표기법
		// 첫글자는 항상 소문자, 여러 단어가 오면 대문자로 구분
		int maxnumber;
		int max_number; // 자바에서는 안씀, 파이썬에서는 사용 (스네이크 기법)
		int maxNumber;
	}
	public void constant() {
		 ...
		 * - 상수의 네이밍 규칙은 대문자로 표기, 여러 단어가 오면 _(언더바)로 구분
		 * */
		int age = 20;
		age = 25;
