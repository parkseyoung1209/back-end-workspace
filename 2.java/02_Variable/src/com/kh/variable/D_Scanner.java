...
public class D_Scanner {
	...
	public static void main(String[] args) {
		...
		//System.out.printf("%s %s %s %s %s %d %s %s %.1f %s %c %s", "당신의 이름은" , name, "이고 사는 곳은", addr, "나이는", age,
		//		"살", "키는", height, "cm, 성별은", gender, "입니다");
		System.out.printf("당신의 이름은 %s이고 사는 곳은 %s 나이는 %d살 키는 %.1fcm, 성별은 %c입니다", name
				, addr, age, height, gender);
	}
}
