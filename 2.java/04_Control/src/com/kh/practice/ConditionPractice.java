...
//		c.method11();
    ...
    public void method4() {
    	...
    	boolean logic = kr>=40 && math >=40 && eng >=40;
    	if(logic && avg>=60) {
    ...
    public void method5() {
    	...
    	double normal = price*0.9;
    	double xx = price * 0.95;
    	if (price>=500000) {
    		System.out.println((int)vip);
    ...
    */
    public void method7() {
    	...
    	}else if (result1 != id && result2 == passwd) {
