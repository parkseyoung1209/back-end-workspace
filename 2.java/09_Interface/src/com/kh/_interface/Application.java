...
public class Application {
	 ...
	 * 추상클래스와 인터페이스
	 * 공통점
	 * 객체 생성은 안되나, 참조 변수로는 사용이 가능하다(즉, 다형성 적용)
...
//		Vehicle v = new Vehicle(); -> 인터페이스는 객체 생성이 불가하다
		Vehicle bus = new Bus();
	 ...
	 * 개발방법론의 변화 : 예전 방식-폭포수(기획-디자인-개발 순차적으로) 요즘-에자일(각각의 단계를 동시 실행)
	 */
