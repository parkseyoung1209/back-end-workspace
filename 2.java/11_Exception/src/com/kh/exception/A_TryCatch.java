...
public class A_TryCatch {
	 ...
	 * 논리적 에러(logical error) : 실행은 되자만, 의도와 다르게 동작
	 * 
	 * 런타임 에러 두 가지!
	 ...
	 * 에외는 발생하더라도 수습될 수 있는 비교적 덜 심각한 것
	 * 
	 * Object -> Throwable -> Exception / Error
	 * 
	 * Exception -->
	 * 					IOException - FileNotFoundException, SockerException
	 ...
	 * } finally {
	 * 		// 예외가 발생하거나 발생하지 않든 무조건 실행되는 코드들
	 *		// close().. finally는 무조건 닫아줘야함
	 * }
	 */
...
//			 printStackTrace : 에외발생 당시의 호출스택(Call Stack)에 있었던
