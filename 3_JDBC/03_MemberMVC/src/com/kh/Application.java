...
public class Application {
	...
	public void login() throws SQLException {
		...
		String password = sc.nextLine();
		member.setPassword(password);
		String login = mc.login(member.getId(), member.getPassword());
		try {
	...
	public void changePassword() throws SQLException {
		...
		boolean cp = mc.changePassword(id, password, newPassword);
		if(cp == true) {
	...
	public void changeName() throws SQLException {
		...
		String password = sc.nextLine();
		member.setPassword(password);
		String userName = mc.login(member.getId(), member.getPassword());
		
		if(!userName.equals(null)) {
			System.out.println("현재 설정된 이름 : " + userName);
			System.out.print("변경할 이름 : ");
			String name = sc.nextLine();
			member.setName(name);
			mc.changeName(member.getName(), member.getId());
		}
